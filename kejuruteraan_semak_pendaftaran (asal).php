...
if (isset($_POST['kemaskini_pendaftaran'])) {
    ...
    if ($stmt_update->execute()) {
        $msg = ($status == 'Lengkap') ? 'Borang disahkan LENGKAP & bil telah berjaya diproses!' : 'Borang diisytiharkan TIDAK LENGKAP.';
            ...
            <?php if ($profil): ?>
                ...
                <div class="info-card mb-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-8 border-top pt-3">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="action-panel mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status_borang" class="form-select form-select-lg fs-6 fw-semibold border-secondary-subtle" required>
